...
from ljcmp.utils.model_utils_zjw import (benchmark, precomputedRoadmap,
...
parser.add_argument('--exp_name', '-E', type=str, default='panda_orientation', help='panda_orientation, panda_dual, panda_dual_orientation, panda_triple')
...
parser.add_argument('--use_distance_model', type=bool, default=False)
...
parser.add_argument('--method', '-M', type=str, default='precomputed_graph_rrt', help='latent_rrt, '
...
# constraint_model, validity_model = load_model(args.exp_name, model_info,
#                                               load_validity_model=True)
# constraint_model, validity_model, sample_model, distance_model = load_model(args.exp_name, model_info,
#                                                                 load_validity_model=True,
#                                                                 load_sample_model=False,
#                                                                 load_distance_model=False)
#
...
if args.method == 'precomput_roadmap':
    precomputedRoadmap(nodeNum=args.nodeNum, exp_name=args.exp_name, model_info=model_info,
                       update_scene_from_yaml=update_scene_from_yaml,
                       constraint=constraint, device=device, condition=condition)
elif args.method == 'comput_pathset':
    generate_path_data(exp_name=args.exp_name,
...
elif args.method == 'generate_scene_start_goal':
    generate_scene_start_goal(exp_name=args.exp_name,
                              constraint=constraint,
                              model_info=model_info,
                              set_constraint=set_constraint,
                              update_scene_from_yaml=update_scene_from_yaml,
...
elif args.method == 'generate_scene_config':
