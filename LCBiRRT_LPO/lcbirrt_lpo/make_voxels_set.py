...
from lcbirrt_lpo.utils.voxel_utils import *
from lcbirrt_lpo.utils.model_utils_zjw import load_model
import numpy as np
import os
import sys
import argparse
...
if args.exp_name == 'panda_orientation':
    dataPath = f'dataset/{args.exp_name}/manifold/data_fixed_10000.npy'
else:
    dataPath = f'dataset/{args.exp_name}/manifold/data_10000.npy'
